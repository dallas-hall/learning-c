...
/**
 * part 3 data structures and function declaratoins
 **/

enum input_result read_moves(struct move[], int*, int);

/**
 * end of part 3 data structure and function declarations
 **/
